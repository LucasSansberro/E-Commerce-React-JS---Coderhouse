...
const ItemDetail = ({ item }) => {
  ...
  return (
    <div className="my-5">
      <div className="container-lg p-3 bg-info bg-opacity-10 border border-info rounded">
        ...
        <div className="row justify-content-around mt-4 mb-3">
          <p className="col-3 btn btn-primary boton-ItemDetail responsiveSizingItemDetail removePointer">
            Precio: ${item.precio}
          </p>
          <p className="col-3 btn btn-primary boton-ItemDetail responsiveSizingItemDetail removePointer">
            Stock: {item.stock}
